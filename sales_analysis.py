...
def authenticate_user():
    if not USER_CREDENTIALS:
        return setup_new_user()  #Creates a new user
    else:
        while True:
...
def display_inventory(remaining_stock):
    print("\nInventory Levels:")
    print(f"{'Item': <30} | {'Remaining Stock': <15}")
    print("-" * 50)
    for item in remaining_stock:
        print(f"{item['Item']: <30} | {item['Remaining Stock']: <15}")
